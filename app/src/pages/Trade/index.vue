  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        ...
        >
        <p @click="changeDefault(userAddressList, userAddress)">
      ...
      <div class="address clearFix">
        <span
          class="username"
          :class="{ selected: payWay == 1 }"
          @click="changePayWay(1)"
          >在线支付</span
        >
        <span
          class="username"
          :class="{ selected: payWay == 2 }"
      ...
      <ul>
        <li>
          <b
            ...
            >件商品，总商品金额</b
          >
          <span>¥{{ trade.originalTotalAmount }}.00</span>
        </li>
        <li>
          <b>返现：</b>
          <span>0.00</span>
...
export default {
  ...
  computed: {
    ...
    defaultAddress() {
      return this.userAddressList.find((address) => address.isDefault == 1)||{} ;
    },
  },
  methods: {
    getTrade() {
    ...
    // 设置默认地址
    changeDefault(userAddressList, userAddress) {
